...
parser.add_argument(
    "-distil_type",
    help="Use distilation crossover. Choices: (fitness) (distance)",
    type=str,
    default="fitness",
)
...
if __name__ == "__main__":
    ...
    while agent.num_frames <= parameters.num_frames:
        ...
        print(
            ...
            agent.num_frames,
            " Train_Max:",
            "%.2f" % best_train_fitness if best_train_fitness is not None else None,
            " Test_Score:",
            "%.2f" % erl_score if erl_score is not None else None,
            " Avg:",
            "%.2f" % tracker.all_tracker[0][1],
